...
import lib.love2d.enums as enums
import lib.love2d.graphics as graphics
import lib.love2d.love as love2d
...
def load():
  love2d.love.graphics.setBackgroundColor(r=0.1, g=0.1, b=0.15)
  hero_img = love2d.love.graphics.newImage("assets/hero.png")

def update(dt):
  if (love2d.love.keyboard.isDown("left") or love2d.love.keyboard.isDown("a")):
    hero_x -= (speed * dt)
  if (love2d.love.keyboard.isDown("right") or love2d.love.keyboard.isDown("d")):
    hero_x += (speed * dt)
  if (love2d.love.keyboard.isDown("up") or love2d.love.keyboard.isDown("w")):
    hero_y -= (speed * dt)
  if (love2d.love.keyboard.isDown("down") or love2d.love.keyboard.isDown("s")):
    hero_y += (speed * dt)

def draw():
  love2d.love.graphics.clear(r=0.1, g=0.15, b=0.2)
  love2d.love.graphics.setColor(0.2, 0.7, 0.5)
  love2d.love.graphics.rectangle(mode=enums.DrawMode.Fill, x=50.0, y=50.0, width=300.0, height=150.0)
  _val_img = hero_img
  if _val_img is not None:
    img = _val_img
    love2d.love.graphics.setColor(1.0, 1.0, 1.0)
    img.draw(x=hero_x, y=hero_y)
  love2d.love.graphics.setColor(1.0, 1.0, 1.0)
  fps_str = ("FPS: " + love2d.love.timer.getFPS())
  love2d.love.graphics.print(text=fps_str, x=10.0, y=10.0)
