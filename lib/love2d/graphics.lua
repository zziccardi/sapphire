...
local Color = {}
Color.__index = Color
function Color.init(kwargs, proto)
  kwargs = kwargs or {}
  local self
  self = setmetatable({}, Color)
  if proto == nil then
    self.a = 1.0
  end
...
local _M = {}
_M.Color = Color
_M.ImageHandle = ImageHandle
_M.CanvasHandle = CanvasHandle
_M.FontHandle = FontHandle
_M.QuadHandle = QuadHandle
_M.Graphics = Graphics
return _M
