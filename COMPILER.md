...
### 1. Generating ANTLR Parsers
To regenerate parser files if the grammar (`Sapphire.g4`) changes:
```bash
antlr -Dlanguage=Python3 -visitor -o src/parser/gen -Xexact-output-dir grammar/Sapphire.g4
```
